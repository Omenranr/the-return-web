  ...
  return (
    ...
    >
      ...
      <Aside emoji="🔫">
        ...
        <ul className="ml-4 list-disc space-y-1 text-sm">
          <li>SNS : 3 000 – 5 000 $</li>
          <li>Pistolet 9 mm : 5 000 – 7 000 $</li>
          <li>Pistolet combat : 7 000 – 10 000 $</li>
      ...
      <Aside emoji="🥷">
        ...
        <ul className="ml-4 list-disc space-y-1 text-sm">
          <li>Perceuse : 200 $</li>
          <li>Perceuse laser : 1 000 $</li>
          <li>Charge thermique : 100 $</li>
          <li>USB : 50 $</li>
          <li>Coupe‑glace : 1 000 $</li>
        </ul>
      </Aside>
    </CardTemplate>
  );
