...
export default function RulesIG() {
  ...
  const articles = [
    ...
    "Si vous constatez un manque de Roleplay ou un non‑respect du règlement, terminez votre scène correctement. Ensuite, contactez‑nous via ticket avec rec à l'appuie (Pas de preuve = Pas de modération).",
    ...
    "Pour tuer un joueur il faut une vrai raison validés par la modération (ticket Mort RP). Exception : les leads ont le droit de vie ou de mort sur leurs membres.",
    "Les avatars volontairement « troll » seront sanctionnés.",
    "Les modificateurs de voix sont autorisés ; tout abus sera considéré comme du troll et sanctionné.",
    "La transition forces de l'ordre / service public ↔ illégal nécessite un wipe obligatoire.",
    "Les EMS, peuvent décider d'une Mort RP en cas de comas ou blessures graves répétés.",
